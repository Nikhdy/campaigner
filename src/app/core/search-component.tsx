...
export class SearchComponent extends React.Component<{}, {}>{
  ...
  render() {
    return <div className='search-with-suggestions-w over-search-field'>
          ...
          <div className='ssg-content'>
            <div className='ssg-items ssg-items-boxed'>
              <a className='ssg-item' href='users_profile_big.html'>
                <div className='item-media' style={{ backgroundImage: '../assets/img/company6.png' }}></div>
                <div className='item-name'>
                  Integ<span>ration</span> with API
                  </div>
              </a><a className='ssg-item' href='users_profile_big.html'>
                <div className='item-media' style={{ backgroundImage: '../assets/img/company7.png' }}></div>
                <div className='item-name'>
        ...
        <div className='search-suggestions-group'>
          ...
          <div className='ssg-content'>
            <div className='ssg-items ssg-items-list'>
              <a className='ssg-item' href='users_profile_big.html'>
                <div className='item-media' style={{ backgroundImage: 'url(../assets/img/avatar1.jpg)' }}></div>
                <div className='item-name'>
                  John Ma<span>yer</span>s
                  </div>
              </a><a className='ssg-item' href='users_profile_big.html'>
                <div className='item-media' style={{ backgroundImage: 'url(../assets/img/avatar2.jpg)' }}></div>
                <div className='item-name'>
                  Th<span>omas</span> Mullier
                  </div>
              </a><a className='ssg-item' href='users_profile_big.html'>
                <div className='item-media' style={{ backgroundImage: 'url(../assets/img/avatar3.jpg)' }}></div>
                <div className='item-name'>
